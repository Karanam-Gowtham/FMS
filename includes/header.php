            ...
            <nav class="nav-menu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login_n.php?event=NAAC">NAAC</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login_n.php?event=NBA">NBA</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=NCC">NCC</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=Sports">Sports</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=Clubs">Clubs</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=NSS">NSS</a>
                        <a class="a_"
                            href="<?php echo $base_url; ?>modules/central/c_login.php?event=Women_Empowerment">Women
                            Empowerment</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=IIC">IIC</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=PASH">PASH</a>
                        <a class="a_"
                            href="<?php echo $base_url; ?>modules/central/c_login.php?event=Antiragging">Antiragging</a>
                        <a class="a_" href="<?php echo $base_url; ?>modules/central/c_login.php?event=SAC">SAC</a>
                    </div>
                </div>
                <div class="dropdown">
                    <button class="btn btn-outline dp">Department</button>
                    <div class="dropdown-content">
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=CSE">CSE</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=AIML">AIML</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=AIDS">AIDS</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=IT">IT</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=ECE">ECE</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=EEE">EEE</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=MECH">MECH</a>
                        <a class="a_" href="<?php echo $base_url; ?>admin/admins.php?dept=CIVIL">CIVIL</a>
                ...
                <a href="<?php echo $base_url; ?>modules/common/pdf_merger.php"><button class="btn dp btn-outline"
                ...
                <?php if (isset($_SESSION['username']) || isset($_SESSION['a_username']) || isset($_SESSION['j_username']) || isset($_SESSION['h_username']) || isset($_SESSION['admin']) || isset($_SESSION['c_cord'])): ?>
                    <a href="<?php echo $base_url; ?>modules/auth/logout.php"><button class="btn dp btn-outline"
