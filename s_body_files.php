...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO s_bodies (Username, acd_year, branch, Body, event_name, from_date, to_date, organised_by, location, participation_status, certificate_path, uploaded_by,submission_time) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)");
...
<body><nav class="navbar">
        <div class="nav-container">
            <div class="nav-items">
                ...
                <span id="sp">&nbsp;  >> &nbsp; </span><span class="sid"> <a href="student_act.php?event=student_act&dept=<?php echo $dept ?>"  class="home-icon" > <?php echo"$event" ?>_Files </a></span>
                <span id="sp">&nbsp;  >> &nbsp; </span><span class="main"> <a href="#" class="main-a"> <?php echo"$activity" ?> </a></span>
                <span id="sp">&nbsp;  >> &nbsp; </span>
            </div>
        </div>
    </nav>
