    ...
    <div class="filter-section">
        <form method="POST" class="filter-form">
            ...
            <select name="selected_branch" id="selected_branch" required>
                ...
                <option value="CSE-CS" <?= $selected_branch === 'CSE-CS' ? 'selected' : '' ?>>CSE-CS</option>
                <option value="CSE-AI&ML" <?= $selected_branch === 'CSE-AI&ML' ? 'selected' : '' ?>>CSE-AI&ML</option>
                <option value="CSE-AI&DS" <?= $selected_branch === 'CSE-AI&DS' ? 'selected' : '' ?>>CSE-AI&DS</option>
                ...
                <option value="MatheMatics" <?= $selected_branch === 'MatheMatics' ? 'selected' : '' ?>>MatheMatics</option>
                <option value="Physics" <?= $selected_branch === 'Physics' ? 'selected' : '' ?>>Physics</option>
                <option value="Chemistry" <?= $selected_branch === 'Chemistry' ? 'selected' : '' ?>>Chemistry</option>
