...
<body>
    ...
    <main class="main-content">
        <div class="container">
            <div class="header">
                <h1>Achievements</h1>
                <a href="download_papers1.php?dept=<?php echo"$dept" ?>" class="btn my-achievements">My Achievements</a>
            </div>
        ...
        <div class="container">
            <div class="header">
                ...
                <a href="dept_down_files.php?dept=<?php echo"$dept" ?>" class="btn my-achievements">My Dept Files</a>
            </div>
