...
function meta_get_fields(string $type_key): array
{
    static $fields = [
        'journal' => [
            ...
            ['name' => 'jcr_quartile',       'label' => 'JCR Quartile',       'type' => 'text',   'required' => false],
        ...
        'dept_file' => [
            ...
            ['name' => 'study_year',    'label' => 'Study Year',       'type' => 'text',   'required' => false],
            ['name' => 'meeting_no',    'label' => 'Meeting No.',      'type' => 'text',   'required' => false],
        ],
        'central_file' => [
        ...
        'exam_qual' => [
            ...
            ['name' => 'exam_status', 'label' => 'Exam Status',    'type' => 'text', 'required' => false],
        ],
        'award' => [
        ...
        'student_event' => [
            ...
            ['name' => 'organised_by',          'label' => 'Organised By',         'type' => 'text', 'required' => false],
            ['name' => 'location',              'label' => 'Location',             'type' => 'text', 'required' => false],
            ['name' => 'participation_status',  'label' => 'Participation Status', 'type' => 'text', 'required' => false],
        ],
        'student_body' => [
            ['name' => 'body_name',             'label' => 'Body Name',            'type' => 'text', 'required' => false],
            ['name' => 'event_name',            'label' => 'Event Name',           'type' => 'text', 'required' => false],
            ['name' => 'from_date',             'label' => 'From Date',            'type' => 'date', 'required' => false],
            ['name' => 'to_date',               'label' => 'To Date',              'type' => 'date', 'required' => false],
            ['name' => 'organised_by',          'label' => 'Organised By',         'type' => 'text', 'required' => false],
