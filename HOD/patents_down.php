...
if (isset($_POST['download_excel'])) {
    ...
    header("Content-Disposition: attachment; filename=patents_table_$branch.xls");
    ...
    while ($row = $result->fetch_assoc()) {
        echo "{$row['Username']}\t{$row['branch']}\t{$row['patent_title']}\t{$row['date_of_issue']}\t{$row['submission_time']}\n";
    }
...
<head>
    ...
    <title>Branch & Patent Records</title>
    <style>
        body {
