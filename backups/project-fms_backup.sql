...
-- End of Workflow Tables, Start of Main Schema --
...
INSERT INTO `reg_dept_cord` (`userid`, `password`, `department`) VALUES
('dept_cord1', '123', 'CSE'),
('dept_cord2', '123', 'AIML'),
('dept_cord3', '123', 'AIDS'),
('dept_cord4', '123', 'IT'),
...
--
-- Table structure and data for table 'r`reg_hod`'
--
...
INSERT INTO 
`reg_hod` (userid, password, department) VALUES
('cse-hod', '123', 'CSE'),
('aiml-hod', '123', 'AIML'),
('aids-hod', '123', 'AIDS'),
('ece-hod', '123', 'ECE'),
