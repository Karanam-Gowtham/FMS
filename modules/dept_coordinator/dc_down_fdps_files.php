        ...
        <div class="filter-section">
            ...
            <input type="hidden" name="action_F" value="<?php echo htmlspecialchars($catg); ?>">
                <select name="dept" id="dept">
                    ...
                    <option value="CSE-CS" <?= isset($_POST['dept']) && $_POST['dept'] == 'CSE-CS' ? 'selected' : '' ?>>CSE-CS</option>
                    <option value="CSE-AI&ML" <?= isset($_POST['dept']) && $_POST['dept'] == 'CSE-AI&ML' ? 'selected' : '' ?>>CSE-AI&ML</option>
                    <option value="CSE-AI&DS" <?= isset($_POST['dept']) && $_POST['dept'] == 'CSE-AI&DS' ? 'selected' : '' ?>>CSE-AI&DS</option>
                    ...
                    <option value="MatheMatics" <?= isset($_POST['dept']) && $_POST['dept'] == 'MatheMatics' ? 'selected' : '' ?>>MatheMatics</option>
                    <option value="Physics" <?= isset($_POST['dept']) && $_POST['dept'] == 'Physics' ? 'selected' : '' ?>>Physics</option>
                    <option value="Chemistry" <?= isset($_POST['dept']) && $_POST['dept'] == 'Chemistry' ? 'selected' : '' ?>>Chemistry</option>
