    ...
    <style>
        ...
        * {
        ...
        .up_ach {
            ...
            align-items: center;
            /* or baseline if you prefer that alignment */
        }
        ...
        .feedback-card {
            ...
            cursor: pointer;
            width: 100%;
            /* optional: makes it behave like block element */
            text-align: left;
            /* if you want content aligned like an anchor */
        }
...
<body>
    <nav class="navbar">
        <div class="nav-container">
            <div class="nav-items">
                ...
                <span class="sp">&nbsp; >> &nbsp;</span><span class="main"><span class="main-a">dept_coordinator</span></span>
            </div>
        </div>
    </nav>
    ...
    <main class="main-content">
        ...
        <div class="feedback-grid">
            ...
            <a href="dc_down_fdps_files.php?dept=<?php echo urlencode($dept); ?>&action_F=fdps_org"
                class="feedback-card">
                <div class="card-content">
            ...
            <a href="dc_down_fdps_files.php?dept=<?php echo urlencode($dept); ?>&action_F=published"
                class="feedback-card">
                <div class="card-content">
            ...
            <a href="dc_down_fdps_files.php?dept=<?php echo urlencode($dept); ?>&action_F=conference"
                class="feedback-card">
                <div class="card-content">
            ...
            <a href="dc_down_fdps_files.php?dept=<?php echo urlencode($dept); ?>&action_F=patents"
                class="feedback-card">
                <div class="card-content">
        ...
        <div class="container">
            ...
            <div class="feedback-grid1">
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=admin"
                    class="feedback-card">
                    <div class="card-content">
                        <h3>Admin Files</h3>
                    </div>
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=faculty"
                    class="feedback-card">
                    <div class="card-content">
                        <h3>Faculty Files</h3>
                    </div>
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=student"
                    class="feedback-card">
                    <div class="card-content">
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=exam_section"
                    class="feedback-card">
                    <div class="card-content">
                ...
                <a href="dc_down_st_act_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=Student%20Activities%20Files"
                    class="feedback-card">
                    <div class="card-content">
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=AMC%20Meeting%20Minutes"
                    class="feedback-card">
                    <div class="card-content">
                ...
                <a href="dc_down_dept_files.php?dept=<?php echo urlencode($dept); ?>&file_type1=Board%20Of%20Studies"
                    class="feedback-card">
                    <div class="card-content">
