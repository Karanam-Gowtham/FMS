...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // SQL Insert Query
    $sql = "INSERT INTO fdps_org_tab (username, branch, title, date_from, date_to, organised_by, location, certificate, brochure, fdp_schedule_invitation, attendance_forms, feedback_forms, fdp_report, photo1, photo2, photo3, submission_time,year)
            VALUES ('$user', '$dept', '$title', '$date_from', '$date_to', '$organised_by', '$location', '$certificate', '$brochure', '$fdp_schedule_invitation', '$attendance_forms', '$feedback_forms', '$fdp_report', '$photo1', '$photo2', '$photo3', '$submission_time','$year')";
...
<nav class="navbar">
        <div class="nav-container">
            <div class="nav-items">
                ...
                <span>&nbsp;  >> &nbsp; </span><span class="main"> <a href="#" class="main-a"> FPDs_org </a></span>
                <span>&nbsp;  >> &nbsp; </span>
            </div>
        </div>
    </nav>
