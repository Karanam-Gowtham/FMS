        ...
        if ($file_error === 0) {
            ...
            if (in_array(strtolower($file_extension), $allowed_extensions)) {
                ...
                if (move_uploaded_file($file_tmp_name, $file_destination)) {
                    ...
                    $sql = "INSERT INTO published_tab (username, branch, paper_title, journal_name, indexing, date_of_submission, quality_factor, impact_factor, payment, submission_time, paper_file,year)
...
<nav class="navbar">
        <div class="nav-container">
            <div class="nav-items">
                ...
                <span>&nbsp;  >> &nbsp; </span><span class="main"> <a href="#" class="main-a"> papers_published </a></span>
                <span>&nbsp;  >> &nbsp; </span>
            </div>
        </div>
    </nav>
