...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // SQL Insert Query
    $sql = "INSERT INTO conf_org_tab (username, branch, title, mode, date_from, date_to, organised_by, location, brochure, fdp_schedule_invitation, attendance_forms, feedback_forms, fdp_report, photo1, photo2, photo3, submission_time,year)
            VALUES ('$user', '$dept', '$title', '$mode', '$date_from', '$date_to', '$organised_by', '$location', '$brochure', '$fdp_schedule_invitation', '$attendance_forms', '$feedback_forms', '$fdp_report', '$photo1', '$photo2', '$photo3', '$submission_time','$year')";
...
<div class="cont1">
<div class="container">
    <h1>Conference Organised Form</h1>
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="certificate">Conference Schedule and Invitation:</label>
        ...
        <div class="form-group">
            <label for="certificate">Conference Report:</label>
